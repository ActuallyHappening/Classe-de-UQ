...
Notice $\X_i$ are all independant and identically distributed (iid).
...
From the Central Limit Theorem (CLT), we can assume $\T$ follow a normal distribution.
$n = 500$ is a reasonable large $n$ for this to be a good approximation.

\[
\T \sim \mathcal{N}(\mu = 895, \sigma = 502.95)
\]

We will ignore the inequality until the end:
