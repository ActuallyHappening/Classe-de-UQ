...
\therefore \E(\Y) &= -p - \frac{1}{8} + \frac{3}{8}  = -p + \frac{1}{4} \\
\Cov(\X, \Y) &= \E [(\X - \E(\X)(\Y - \E(\Y)] \\
\Cov(\X, \Y) &= \sum _{c \in \Omega} (\X(c) - \E(\X)(\Y(c) - \E(\Y))\pr{c} \\
&= \sum _{x,y} (x + (+3p - \frac{1}{4}))(y + (p - \frac{1}{4})\p(\{ \X = x \} \cap \{ \Y = y \}) \\
\end{align*}
Expanding this sum is tedious and results in nine trinomials.
The following sum expansion significantly reduces the algebra necessary:
...
\implies \Cov(\X, \Y) &= (-p + \frac{1}{8}) + (-3p + \frac{1}{4})(-p + \frac{1}{4}) \\
&= -p + \frac{1}{8} + 3p - \frac{3}{4} - \frac{1}{4}p + \frac{1}{16} \\
&= (-1 + 3 -\frac{1}{4})p + (\frac{1}{8} - \frac{3}{4} + \frac{1}{16}) \\
&= \frac{7}{4}p - \frac{9}{16}
\end{align*}
