...
def patient():
	...
	if hours_since_last_dose < 24.0:
		morphine_milligrams_remaining = MorphineModel(dose_amount_milligrams, hours_since_last_dose)
		print(f"There is approximately {morphine_milligrams_remaining:.2f}mg of morphine remaining")
	else:
